...
public class StAXModelBuilder implements XMLStreamConstants {
     ...
     * START_ELEMENT with a local name of element
     * 
     * It returns a NamedElement representing that element and its children and
     * advances the reader to the next tag past the END_ELEMENT of the element
     * handle started
     * 
     * The parent on the returned FormProvider is not set, so this must be
     * handled by the object calling this.
    ...
    /**
     * Method handleElement assumes that the reader has been advanced to a
     * START_ELEMENT with a local name of ref
     * 
