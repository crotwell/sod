...
public abstract  class AbstractNetworkDatabase implements NetworkDatabase{
    ...
    public int putNetwork(String serverName,
        ...
        try {
            ...
            networkAccessIor = orb.object_to_string((org.omg.CORBA.Object)networkAccess); netPutStmt.setString(8, networkAccessIor);
        ...
        try {
            ...
            if(rs.next()) {
                ...
                for (int i=0 ; i< retries; i++) {
                    try {
                        logger.debug("1 "+ior+"  "+orb.getClass().getName());
                        logger.debug(edu.sc.seis.fissuresUtil.exceptionHandler.ExceptionReporterUtils.getMemoryUsage()+" after sleep");
