...
public class SaveSeismogramToFileDOM implements LocalSeismogramProcess {
    /**
     ...
     * for this Processor
     */
    public SaveSeismogramToFileDOM (Element config) throws ConfigurationException {
        this.config = config;
        String fileTypeStr =
    ...
    private static final Logger logger =
        Logger.getLogger(SaveSeismogramToFileDOM.class);
