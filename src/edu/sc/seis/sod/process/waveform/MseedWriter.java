...
public class MseedWriter extends AbstractSeismogramWriter {
    ...
    private static final String DEFAULT_FILE_TEMPLATE = "seismograms/Event_${event.getTime('yyyy_MM_dd_HH_mm_SS')}/${channel.codes}.mseed";

    public MseedWriter(Element el) {
        super(extractFileTemplate(el, DEFAULT_FILE_TEMPLATE), extractPrefix(el));
    }
