...
public class OriginPointBackAzimuth extends AbstractOriginPoint implements
        OriginSubsetter {
    ...
    public StringTree accept(EventAccessOperations event,
        ...
        if(AzimuthUtils.isBackAzimuthBetween(distaz, min, max)) {
            ...
            logger.debug("reject back azimuth baz=" + distaz.getBaz() + "  "
                    + min + " " + max);
            return  new StringTreeLeaf(this, false, distaz.getBaz() + " not between  "
                                       + min + ", " + max);
        }
    }
