    ...
    public NetworkInfoTemplateGenerator(Element el) throws Exception{
        ...
        if (fileDir == null || netFormatter == null || staFormatter == null || netConfig == null
            ...
            throw new IllegalArgumentException(
                "The configuration element must contain a fileDir, netsOutputFileName, netDir, stationsOutputFileName, stationDir,"
                    + " channelsOutputFileName, netConfig, stationConfig,  and chanConfig.");
        }
