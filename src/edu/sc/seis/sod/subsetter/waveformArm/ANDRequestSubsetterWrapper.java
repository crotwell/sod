...
public class ANDRequestSubsetterWrapper implements ChannelGroupRequestSubsetter {

    public ANDRequestSubsetterWrapper(RequestSubsetter subsetter) {
        this.subsetter = subsetter;
    }

    public ANDRequestSubsetterWrapper(Element config) throws ConfigurationException{
