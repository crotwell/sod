...
public class ANDAvailableDataWrapper implements ChannelGroupAvailableDataSubsetter {

    public ANDAvailableDataWrapper(AvailableDataSubsetter subsetter) {
        this.subsetter = subsetter;
    }

    public ANDAvailableDataWrapper(Element config) throws ConfigurationException{
