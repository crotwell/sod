...
public class PassLocalSeismogram implements LocalSeismogramSubsetter, ChannelGroupLocalSeismogramSubsetter {

    public PassLocalSeismogram(){}

    public PassLocalSeismogram(Element config) {}
