...
public class ChannelGroupRequestSubsetterOR extends WaveformLogicalSubsetter
    implements ChannelGroupRequestSubsetter {

    public ChannelGroupRequestSubsetterOR(Element config) throws ConfigurationException{
        super(config);
    }
