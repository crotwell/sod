...
public class ORLocalSeismogramSubsetterWrapper implements ChannelGroupLocalSeismogramSubsetter {

    public ORLocalSeismogramSubsetterWrapper(LocalSeismogramSubsetter subsetter) {
        this.subsetter = subsetter;
    }

    public ORLocalSeismogramSubsetterWrapper(Element config) throws ConfigurationException{
