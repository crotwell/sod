...
public class ChannelGroupAvailableDataAND extends WaveformLogicalSubsetter
    implements ChannelGroupAvailableDataSubsetter {

    public ChannelGroupAvailableDataAND(Element config) throws ConfigurationException{
        super(config);
    }
