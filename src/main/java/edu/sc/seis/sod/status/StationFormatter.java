    ...
    protected Object getTemplate(String tag, final Element el) {
        if(tag.equals("name")) {
            return new StationTemplate() {
                ...
                public String getResult(StationImpl sta) {
                    return sta.getName();
                }
            };
            ...
            return new StationTemplate() {
                ...
                public String getResult(StationImpl sta) {
                    return Double.toString(sta.getLocation().depth.getValue());
                }
            };
            ...
            return new StationTemplate() {
                ...
                public String getResult(StationImpl sta) {
                    return Double.toString(sta.getLocation().elevation.getValue());
                }
            };
            ...
            return new StationTemplate() {
                ...
                public String getResult(StationImpl sta) {
                    return btt.getResult(sta.getEndTime());
                }
            ...
            return new StationTemplate() {
                ...
                public String getResult(StationImpl sta) {
                    return sta.get_id().begin_time.getISOTime();
                }
            };
