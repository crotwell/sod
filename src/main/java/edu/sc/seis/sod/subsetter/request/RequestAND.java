...
public final class RequestAND extends RequestLogical implements Request {
    ...
    public boolean accept(CacheEvent event,
        ...
        while(it.hasNext()) {
            ...
            if(filter.accept(event, channel, original, cookieJar) == false) { return false; }
        }
        return true;
    }

    static Category logger = Category.getInstance(RequestAND.class.getName());
}// RequestSubsetterAND
