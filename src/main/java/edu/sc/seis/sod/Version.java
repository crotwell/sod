...
public class Version{
    ...
    public static Version[] versionsToDate = {
      ...
      new Version("3.0.1rc1", false),
      new Version("3.1.0", false),
      new Version("3.1.1beta1", false),
      new Version("3.2.0", false),
      new Version("3.2.1", false),
      ...
      new Version("3.2.10-SNAPSHOT2", false),
      new Version("3.2.10-SNAPSHOT3", false),
      new Version("3.2.10-SNAPSHOT4", false),
      ...
      new Version("3.2.11-SNAPSHOT6", false)
    };
