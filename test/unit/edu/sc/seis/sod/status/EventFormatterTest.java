...
public class EventFormatterTest extends TestCase{
    ...
    public void testRegionName() throws ConfigurationException {
    ...
    public void testRegionNumber() throws ConfigurationException {
    ...
    public void testDepth() throws ConfigurationException {
    ...
    public void testDefaultName() throws ConfigurationException {
        EventFormatter gen = EventFormatter.getDefaultFormatter();
    ...
    public void testFilize(){
        assertEquals("test_____test", EventFormatter.filize("\t\n test \t\n:_  test\n\t  "));
    }

    public void testComplicatedMarkup() throws ConfigurationException {
        try {
