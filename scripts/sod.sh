...
FISSURESUTIL=$MAVEN/repository/fissuresUtil/jars/fissuresUtil-1.0Beta.jar
FISSURESIMPL=$MAVEN/repository/fissuresImpl/jars/fissuresImpl-1.1Beta.jar
...
XALAN=$MAVEN/repository/xalan/jars/xalan-2.4.1.jar
XERCES=$MAVEN/repository/xerces/jars/xerces-2.3.0.jar
...
java -cp ${SEEDCODEC}:${SOD}:${FISSURESIDL}:${FISSURESIMPL}:${FISSURESUTIL}:${OB}:${OBNAMING}:${XERCES}:${XMLAPI}:${XALAN}:${TAUP}:${LOG4J}:${HSQLDB}:${CLASSPATH} edu.sc.seis.sod.Start $*
