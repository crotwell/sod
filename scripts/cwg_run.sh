...
FULLPATH=${SEEDCODEC}${SEP}${SOD}${SEP}${FISSURESIDL}${SEP}${FISSURESIMPL}${SEP}${FISSURESUTIL}${SEP}${OB}${SEP}${OBNAMING}${SEP}${XERCES}${SEP}${XMLAPI}${SEP}${XALAN}${SEP}${TAUP}${SEP}${LOG4J}${SEP}${HSQLDB}${SEP}${CLASSPATH} 
